...
/* harmony import */ var _modules_products__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/products */ "./js/modules/products.js");
...
var ERROR_MESSAGE = 'Проблемы с соединением, проверьте подключение';
...
var setPriceSwitchButtons = function setPriceSwitchButtons(card, hasAlt) {
...
var errorHandler = function errorHandler(error) {
  ...
  elem.textContent = "".concat(ERROR_MESSAGE, "\n").concat(error);

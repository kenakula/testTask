...
/* harmony import */ var _modules_card_price_switch__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/card-price-switch */ "./js/modules/card-price-switch.js");
/* harmony import */ var _modules_load_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/load-data */ "./js/modules/load-data.js");
...
Object(_modules_card_price_switch__WEBPACK_IMPORTED_MODULE_3__["buttonSwitch"])();
...
fetch(DATA_URL).then(function (response) {
  ...
  data.forEach(function (obj) {
    var card = Object(_products__WEBPACK_IMPORTED_MODULE_1__["setCard"])(obj);
...
var cardTemplate = document.querySelector('#card').content.querySelector('.product-card');
